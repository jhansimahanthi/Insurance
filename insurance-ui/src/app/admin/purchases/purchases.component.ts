    ...
    <div class="admin-layout">
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          <a routerLink="/admin/purchases" class="nav-item active">🛒 Purchases</a>
          <a routerLink="/admin/claims" class="nav-item">📝 Claims</a>
        </nav>
      </aside>
      <main class="main-content">
        <div class="page-header"><h1>Purchase Management</h1></div>
        <div class="card">
          <div class="table-container">
            <table>
              <thead><tr><th>Purchase #</th><th>Customer</th><th>Policy</th><th>Premium</th><th>Start</th><th>End</th><th>Status</th></tr></thead>
              <tbody>
            ...
            <div *ngIf="purchases.length === 0" class="empty-state" style="padding: 40px; text-align: center;"><p class="text-muted">No purchases found.</p></div>
          </div>
        </div>
      </main>
    </div>
